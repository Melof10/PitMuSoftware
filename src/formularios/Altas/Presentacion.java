 ...
 * @author Federico
 */
public final class Presentacion extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;
    cargar hilo;    
    
    public Presentacion(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Creando Torneo...");

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/trophy(1).png"))); // NOI18N
    ...
    private void progresoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_progresoStateChanged
        if (progreso.getValue() == 100) {
            dispose();
            new alertas.AlertSuccess(new javax.swing.JDialog(), true, "Se ha creado el Torneo correctamente").setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Presentacion dialog = new Presentacion(new javax.swing.JDialog(), true);
